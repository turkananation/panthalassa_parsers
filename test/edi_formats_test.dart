...
void main() {
  ...
  test('HL7 v2 ADT message: delimiters, message type, version, data text', () {
    ...
    final msg = 'MSH|^~\\&|EPIC|HOSP|LAB|DH|20260115||ADT^A01|MSG00001|P|2.5.1\r'
  ...
  test('X12 850 purchase order: ISA delimiters, transaction set, elements', () {
    ...
    const rest = 'GS*PO*SENDER*RECEIVER*20260115*1200*1*X*005010~'
        'ST*850*0001~'
  ...
  test('EDIFACT still parses after additions (regression)', () {
    final r = reg.parse(u8("UNA:+.? 'UNB+UNOC:3+SENDER+RECEIVER+260115:1200+1'"
